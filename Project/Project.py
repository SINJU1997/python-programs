...
color_box = color_box.subsample(5,4)
Label(root,image=color_box,bg="#f2f3f5").place(x=10, y=20)

eraser=PhotoImage(file="eraser.png")
eraser = eraser.subsample(25,15)
Button(root,image=eraser,bg="#f2f3f5", command=new_canvas).place(x=48,y=420)


colors=Canvas(root,bg="#ffffff",width=37,height=300,bd=0)
colors.place(x=48,y=80)
...
def display_pallete():
    ...
    id=colors.create_rectangle((10,220,30,240),fill='white')
